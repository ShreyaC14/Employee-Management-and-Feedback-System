    ...
    <main>
        <div class="card-container">
            <div class="card">
                ...
                <img src="images/complete_registration.png" style="height: 50px; margin-bottom: 20px; margin-top: 20px;">
                <br>
                <a href="Complete_reg.php"><button>Complete Registration</button></a>
            </div>
            <div class="card">
                <h2>Check Registration Details</h2>
                <img src="images/check_your_details.jpeg" style="height: 50px; margin-bottom: 10px; margin-top: 20px;">
                <br>
